            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="guest-input w-full border border-gray-200 text-gray-900 outline-none focus:ring-2 focus:ring-vailo-teal/20"
                />
              </div>
            ...
            <form onSubmit={handleTesterSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="guest-input w-full border border-gray-200 rounded-xl text-base font-mono tracking-widest text-gray-900 outline-none focus:ring-2 focus:ring-vailo-teal/20"
                />
              </div>
              {error && <p className="text-sm text-red-600">{error}</p>}
              <button
