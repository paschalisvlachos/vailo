...
export type GuestLocaleKey =
  ...
  | 'checkInPromoDoneSub'
  | 'checkInWrongDates'
  | 'checkInWrongDatesConfirmTitle'
  | 'checkInWrongDatesConfirmBody'
  | 'checkInWrongDatesConfirmContinue'
  | 'checkInWrongDatesConfirmCancel'
  | 'checkInBackToPortal'
  | 'checkInNoteEyebrow'
  | 'checkInNoteFree'
  | 'checkInNoteLocals'
