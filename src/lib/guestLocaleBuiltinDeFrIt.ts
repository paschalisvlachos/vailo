...
export const UI_DE: Partial<Record<GuestLocaleUiKey, string>> = {
  ...
  wifiCopied: 'Kopiert',
  serviceVoucherLabel: 'Gutscheincode',
  serviceVoucherHint: 'Sie können diesen Code auf der Partner-Website einlösen.',
  serviceVoucherCopied: 'Kopiert',
...
export const UI_FR: Partial<Record<GuestLocaleUiKey, string>> = {
  ...
  wifiCopied: 'Copié',
  serviceVoucherLabel: 'Code promo',
  serviceVoucherHint: 'Vous pouvez utiliser ce code sur le site du partenaire.',
  serviceVoucherCopied: 'Copié',
...
export const UI_IT: Partial<Record<GuestLocaleUiKey, string>> = {
  ...
  wifiCopied: 'Copiato',
  serviceVoucherLabel: 'Codice voucher',
  serviceVoucherHint: 'Puoi usare questo codice sul sito del partner.',
  serviceVoucherCopied: 'Copiato',
