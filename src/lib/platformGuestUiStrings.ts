...
const STALE_GUEST_UI_OVERRIDES: Partial<Record<GuestUiStringKey, string[]>> = {
  ...
  assistantProperty: [
    ...
    'AI property chatbot',
    'AI chatbot καταλύματος',
    'KI-Chatbot der Unterkunft',
    'Chatbot IA du logement',
    'Chatbot IA della struttura',
    'AI Chatbot',
    'KI-Chatbot',
    'Chatbot IA',
  ],
  assistantPropertySub: [
    ...
    'Ask anything about the accommodation and your stay',
    'Ask anything about your accommodation',
    'Ask anything about your stay',
    'Ρωτήστε οτιδήποτε για το κατάλυμα και τη διαμονή σας',
    'Ρωτήστε οτιδήποτε για το κατάλυμά σας',
    'Ρωτήστε οτιδήποτε για τη διαμονή σας',
    'Fragen Sie alles zur Unterkunft und Ihrem Aufenthalt',
    'Fragen Sie alles zu Ihrer Unterkunft',
    'Fragen Sie alles zu Ihrem Aufenthalt',
    'Posez toutes vos questions sur le logement et votre séjour',
    'Posez toutes vos questions sur votre logement',
    'Posez toutes vos questions sur votre séjour',
    'Chiedi qualsiasi cosa sulla struttura e sul tuo soggiorno',
    'Chiedi qualsiasi cosa sul tuo alloggio',
    'Chiedi qualsiasi cosa sul tuo soggiorno',
  ],
  bookArrangeHomeTitle: ['Book & Arrange'],
  bookArrangeHomeSub: ['Turn good holidays into unforgettable ones.'],
  aiExpertOrEnterTown: [
